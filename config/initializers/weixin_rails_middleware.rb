...
WeixinRailsMiddleware.configure do |config|
  ...
  # config.weixin_token_string = 'c175df7b8dcd87b5eaf7bac3'
  # using to weixin server url to validate the token can be trusted.
  # config.weixin_secret_string = 'cnrOZ_KFaJdpJAR45kyP5lEO1ktMeM9k'
  # 加密配置，如果需要加密，配置以下参数
  # config.encoding_aes_key = '0453cb0116035d49c26a19360f8b1fd8b3404ed176f'
